...
<form id="createList">
	...
	>
		...
		<div class="flex justify-between">
			<div class="overflow-hidden [*]:text-[#596680] 
			flex">
				<div class="mr-11 ml-5 text-[14px] transition-colors duration-300 ease-[cubic-bezier(0.645,0.045,0.355,1)]"
					...
					<section class="flex w-full">
						<div class="mb-3.5 w-1/2">
							<div class="mb-3 h-8 leading-8">
								...
								<div class="inline-block w-1/2">
									<div class=" h-8 leading-8">
										<select class="border-[#a4adb7]" name="priority" id="priority" bind:value={priority}>
