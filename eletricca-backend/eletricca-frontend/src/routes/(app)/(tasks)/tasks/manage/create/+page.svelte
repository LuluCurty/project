    ...
    <div class="max-w-3xl mx-auto space-y-6 pb-20">
        ...
        <div class="flex items-center justify-between gap-4">
            <div class="flex items-center gap-4">
                ...
                <div>
                    <h2 class="text-2xl font-bold tracking-tight text-primary">Nova Tarefa</h2>
                    <p class="text-muted-foreground">Defina a tarefa e suas etapas para atribuir a usuários</p>
                </div>
            </div>
            ...
            <Card.Content class="space-y-3">
                ...
                {:else}
                    <div class="flex flex-col items-center justify-center py-8 rounded-md border border-dashed text-center">
                        ...
                        <p class="text-xs text-muted-foreground/70 mt-1">Adicione etapas abaixo para definir o checklist da tarefa</p>
                    </div>
                {/if}
        ...
        <div class="flex justify-end gap-2">
            <Button type="button" variant="outline" onclick={() => goto('/tasks/manage')}>Cancelar</Button>
            <Button type="submit" disabled={submitting}>
                <Save class="mr-2 size-4" /> Criar Tarefa
            </Button>
        </div>
    </div>
</form>
